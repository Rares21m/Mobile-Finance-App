  ...
  return (
    <View className="flex-1 bg-background pt-14">
      ...
      >
        ...
        {accounts.length > 0 && (
          <View
            className="mx-6 mt-4 rounded-3xl overflow-hidden"
            style={{
          ...
          <View className="px-6 mt-6">
            ...
            {accounts.map((account, index) => {
              ...
              return (
                ...
                >
                  <View className="w-10 h-10 rounded-full bg-accent/[0.1] items-center justify-center mr-3">
                    <Ionicons
                      name="wallet-outline"
                      size={18}
                      color={c.accent}
                  ...
                  <View className="flex-1">
                    <Text
                      ...
                      numberOfLines={1}
                    >
                      {account.name || account.iban || "Cont BT"}
                    </Text>
                    <Text className="text-text-muted text-xs mt-0.5">
                  ...
                  <View className="items-end">
                    <Text className="text-foreground font-bold text-base">
                      {parseFloat(bal.amount).toLocaleString("ro-RO", {
                        minimumFractionDigits: 2,
                      })}
                    </Text>
                    <Text className="text-text-muted text-xs mt-0.5">
            ...
            <View className="bg-surface rounded-2xl border border-border p-4">
              <View className="flex-row">
                ...
                <View className="flex-1 items-center py-2">
                  <View className="w-9 h-9 rounded-full bg-accent/[0.1] items-center justify-center mb-2">
                    <Ionicons
                ...
                {/* Income */}
                <View className="flex-1 items-center py-2">
                  <View className="w-9 h-9 rounded-full bg-success/[0.1] items-center justify-center mb-2">
                ...
                {/* Expenses */}
                <View className="flex-1 items-center py-2">
                  <View className="w-9 h-9 rounded-full bg-expense/[0.1] items-center justify-center mb-2">
        ...
        {/* ===== CONNECT BUTTONS ===== */}
        {(() => {
          const isBTConnected = connections.some(
            (c) => c.bankName === "BT" && c.status === "active",
          );
          const isBRDConnected = connections.some(
            (c) => c.bankName === "BRD" && c.status === "active",
          );
            ...
            >
              ...
              >
                {isLoading ? (
                  ...
                  <View
                    className={`w-10 h-10 rounded-xl ${bgClass} items-center justify-center`}
                  >
                    <Ionicons
                ...
                <View className="flex-1">
                  ...
                  >
                    {isConnected
                      ? `${bankLabel} — Conectat`
                      : `Conectează ${bankLabel}`}
                  </Text>
                  <Text className="text-text-muted text-xs mt-0.5">
                    {isConnected
                      ? "Apasă pentru a reconecta"
